...
\dirtree{%
    ...
    .2 models.
    .3 hand\_model.py\DTcomment{\autoref{sec:hand_model}\quad\textbf{71 lines}}.
    ...
    .2 utils.
    .3 bsldict\_data\_processing.py\DTcomment{\autoref{sec:data}\quad\textbf{37 lines}}.
    .3 bsldict\_preprocessing.py\DTcomment{\autoref{sec:data}\quad\textbf{38 lines}}.
    ...
    .3 constants.py\DTcomment{\autoref{sec:constants}\quad\textbf{13 lines}}.
    ...
    .3 performance.py\DTcomment{\autoref{sec:performance}\quad\textbf{37 lines}}.
    ...
    .2 eval.py\DTcomment{Script to run test data evaluation\quad\textbf{64 lines}}.
    .2 main.py\DTcomment{Script to run real-time detection\quad\textbf{46 lines}}.
}
