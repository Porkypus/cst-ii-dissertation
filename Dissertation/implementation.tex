...
\dirtree{%
    .1 .
    .2 data\DTcomment{Folder to store keypoint data in numpy arrays}.
    ...
    .2 test\_videos\DTcomment{Stored videos for testing}.
    .2 train\_videos\DTcomment{Stored videos for training}.
    .2 utils.
    .3 bsldict\_data\_processing.py\DTcomment{Sort videos in train and test\quad\textbf{35 lines}}.
    .3 bsldict\_preprocessing.py\DTcomment{Extract labels with enough data\quad\textbf{36 lines}}.
    ...
    .3 constants.py\DTcomment{Constants and Parameters\quad\textbf{11 lines}}.
    .3 feature\_extraction.py\DTcomment{\autoref{sec:feature}\quad\textbf{172 lines}}.
    .3 lsa64\_data\_processing.py\DTcomment{Sort videos in train and test\quad\textbf{42 lines}}.
    .3 mediapipe\_utils.py\DTcomment{\autoref{sec:mediapipe}\quad\textbf{67 lines}}.
    .3 sign\_eval.py\DTcomment{Class to evaluate signs in test data\quad\textbf{45 lines}}.
    .3 sign\_recorder.py\DTcomment{Class to record and process signs\quad\textbf{120 lines}}.
    .3 webcam\_manager.py\DTcomment{Class which handles OpenCV and recording\quad\textbf{71 lines}}.
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[scale=0.21]{images/holistic_pipeline.png}
