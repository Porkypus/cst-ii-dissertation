...
\dirtree{%
    ...
    .2 models.
    .3 hand\_model.py\DTcomment{\autoref{sec:hand_model}\quad\quad\textbf{71 lines}}.
    .3 pose\_model.py\DTcomment{\autoref{sec:pose_model}\quad\quad\textbf{48 lines}}.
    .3 sign\_model.py\DTcomment{\autoref{sec:sign_model}\quad\quad\textbf{76 lines}}.
    .2 utils.
    .3 bsldict\_data\_processing.py\DTcomment{\autoref{sec:data}\quad\quad\textbf{37 lines}}.
    .3 bsldict\_preprocessing.py\DTcomment{\autoref{sec:data}\quad\quad\textbf{38 lines}}.
    .3 compute\_dtw.py\DTcomment{\autoref{sec:dtw-python}\quad\quad\textbf{56 lines}}.
    .3 compute\_fastdtw.py\DTcomment{\autoref{sec:fastdtw}\quad\quad\textbf{45 lines}}.
    .3 constants.py\DTcomment{\autoref{sec:constants}\quad\quad\textbf{13 lines}}.
    .3 feature\_extraction.py\DTcomment{\autoref{sec:feature}\quad\textbf{ 173 lines}}.
    .3 lsa64\_data\_processing.py\DTcomment{\autoref{sec:data}\quad\quad\textbf{42 lines}}.
    .3 mediapipe\_utils.py\DTcomment{\autoref{sec:mediapipe}\quad\quad\textbf{67 lines}}.
    .3 performance.py\DTcomment{\autoref{sec:performance}\quad\quad\textbf{37 lines}}.
    .3 sign\_eval.py\DTcomment{\autoref{sec:sign_eval}\quad\textbf{ 116 lines}}.
    .3 sign\_recorder.py\DTcomment{\autoref{sec:sign_recorder}\quad\textbf{ 120 lines}}.
    .3 webcam\_manager.py\DTcomment{\autoref{sec:webcam}\quad\quad\textbf{71 lines}}.
    .2 eval.py\DTcomment{Script to run test data evaluation\quad\quad\textbf{64 lines}}.
    .2 main.py\DTcomment{Script to run real-time detection\quad\quad\textbf{46 lines}}.
}
...
\verb|bsldict_preprocessing.py| is a script used if we wish to filter labels which have more than a minimum number of videos. For example, it can be used to filter the dataset by getting all labels which have at least 10 videos.
